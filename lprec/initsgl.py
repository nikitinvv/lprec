...
def create_gl(N,Nproj,Nslices,cor,interp_type):
	...
	(Nrho,Ntheta,dtheta,drho,aR,am,g)=getparameters(beta,proj[1]-proj[0],2.0/(N-1),N,size(proj))
	...
	P=Pgl(Nspan,N,Nproj,Nslices,Ntheta,Nrho,proj,s,thsp,rhosp,aR,beta,B3com,am,g,cor,interp_type)

	#represent as array
	params = float32(append([P.N,P.Ntheta,P.Nrho,P.Nspan,P.Nproj,P.Nslices,P.cor,P.interp_type=='cubic'],erho))
	return (P,params)
