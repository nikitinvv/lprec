...
class lpRgpu(_object):
    ...
    def readGlobalParameters(self, *args): return _lpRgpu.lpRgpu_readGlobalParameters(self, *args)
    def readFwdParameters(self, *args): return _lpRgpu.lpRgpu_readFwdParameters(self, *args)
    def readAdjParameters(self, *args): return _lpRgpu.lpRgpu_readAdjParameters(self, *args)
